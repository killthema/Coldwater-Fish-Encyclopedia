 ...
 * [작동 순서]: 접속 주소를 확인 -> 로그인 여부 체크(isAuthenticated) -> 해당 페이지 컴포넌트 호출 [cite: 2026-01-13]
 */
...
function App() {
  // [역할]: 로컬 스토리지에 사용자 정보가 있는지 확인하여 로그인 여부를 판단합니다. [cite: 2026-02-19]
  const isAuthenticated = localStorage.getItem('user');

  return (
    <Router>
      <Routes>
        {/* 1. 기본 화면: 로그인이 안 되어 있으면 무조건 로그인 페이지로 [cite: 2026-01-13] */}
        ...
        {/* [수정 포인트]: 태그 끝에 />를 추가하여 문법 오류 해결! [cite: 2026-02-19] */}
